...
const About = () => {
  return (
    <div name="about" className="w-full h-screen bg-[#060918] text-[#FFFEF9]">
      <div className="flex flex-col justify-center items-center w-full h-full">
        ...
        <div className="max-w-[1000px] w-full  grid sm:grid-cols-2 gap-8 px-4">
          ...
          <div>
            ...
            <p>
              In my free time, I like to experiment with new coding techniques
              and frameworks, and I am constantly seeking out new resources to
